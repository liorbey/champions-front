    ...
    <div className="container">
        <div className="row">
            <div className="col-md-12">
                <h1 className="career_title">We're Hiring!</h1>
                <h1 className="career_sub">Join our passionate team working each day to improve patients' lives.</h1>
                <a href="/careers" className="btn btn--white btn--width">Careers</a>
            </div>
        </div>
    </div>
    ...
    <div className="container">
        <div className="row">
            <div className="col-md-2 col-xs-6">
                <img className="footer__img" src={logo} width="150px"/></div>
            <div className="col-md-10 col-xs-6">
                <div className="footer__social">
                    <a href="https://www.facebook.com/championsoncology" target="_blank" className="footer__social-l">
                    ...
                    <a href="https://www.linkedin.com/company/champions-oncology-inc-" target="_blank"
                    ...
                    <a href="https://twitter.com/champsonco?lang=en" target="_blank" className="footer__social-l">
